#!/usr/bin/env python3
"""Monta "La Patasola" (TikTok 9:16) a partir de los clips generados en Magnific
y la voz en off original.
...
Style: TITULO,{FUENTE},104,&H001E1ECC,&H001E1ECC,&H00000000,&H96000000,0,0,0,0,100,100,4,0,1,6,6,5,40,40,0,1
...
def construir_ass(spec, palabras, destino):
    ...
    ev.append(f"Dialogue: 2,{ass_tiempo(t['ini'])},{ass_tiempo(t['fin'])},TITULO,,0,0,0,,"
              r"{\fad(120,400)\t(0,1800,\fscx108\fscy108)}" + limpiar(t["texto"]))
